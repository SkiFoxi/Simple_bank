postgres:
	docker run --name postgres12 -p 5444:5432 -e POSTGRES_USER=root -e POSTGRES_PASSWORD=secret -d postgres:12
...
.PHONY:postgres createdb dropdb migrateup migratedown generate server